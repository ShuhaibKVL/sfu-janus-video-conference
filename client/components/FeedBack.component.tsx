    ...
    const feedbackCards = [
        {
            ...
            fields: ["Meeting quality", "Audio/video quality", "Ease of communication"],
        },
        {
        ...
        },
        {
            ...
            description:
                "Understand connection stability and platform performance.",
            fields: ["Network stability", "Video smoothness", "Screen share quality"],
        },
        {
            title: "Feature Suggestions",
            description:
                "Allow users to suggest new features and improvements.",
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-neutral-400 text-lg max-w-3xl">
                        A modern feedback collection flow for your Janus SFU video conferencing platform.
                    </p>
                </div>
                    ...
                    {feedbackCards.map((card, index) => (
                        <div key={index}
                            ...
                            <div className="flex items-center justify-between mb-5">
                                ...
                                <div
                                    className="w-12 h-12 rounded-2xl bg-blue-500/20 flex items-center justify-center text-xl font-bold text-blue-400">
                                    {index + 1}
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                {card.fields.map((field, fieldIndex) => (
                                    <div key={fieldIndex} className="rounded-2xl bg-black/40 border border-white/5 p-4">
                            ...
                            <button
                                className="w-full mt-5 py-4 rounded-2xl bg-blue-500 hover:bg-blue-600 font-semibold text-lg transition-all duration-300">
                                Submit Feedback
                            </button>
                        </div>
                    ))}
                ...
                <div className="mt-12 rounded-3xl border border-white/10 bg-neutral-900 p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                        {[
                            ...
                            <div key={index} className="rounded-2xl bg-black/40 border border-white/10 p-5">
                                <div
                                    className="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center mb-4 text-blue-400 font-bold">
                                    {index + 1}
                                </div>
